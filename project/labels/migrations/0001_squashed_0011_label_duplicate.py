# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2019-11-06 05:54
...
class Migration(migrations.Migration):
    ...
    replaces = [(b'labels', '0001_initial'), (b'labels', '0002_label'), (b'labels', '0003_labelset'), (b'labels', '0004_locallabel'), (b'labels', '0005_create_locallabels_for_existing_labelsets'), (b'labels', '0006_label_rename_code_to_default_code'), (b'labels', '0007_alter_label_default_code_verbose_name'), (b'labels', '0008_remove_labelset_labels'), (b'labels', '0009_add_verified_field_and_permission'), (b'labels', '0010_add_labelset_committee'), (b'labels', '0011_label_duplicate')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_code', models.CharField(max_length=10, verbose_name=b'Default Short Code')),
